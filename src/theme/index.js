export default {
	...
	"font": {
		"headline1": "normal 700 72px/1.2 --fontFamily-googleSourceSansPro",
		"headline2": "normal 600 42px/1.2 --fontFamily-googleSourceSansPro",
		"headline3": "normal 500 35px/1.2 --fontFamily-googleSourceSansPro",
		"base": "normal 300 16px/1.5 --fontFamily-googleSourceSansPro",
		"lead": "normal 300 20px/1.5 --fontFamily-sans",
		"headline4": "500 20px/1.5 --fontFamily-googleSourceSansPro",
		"minitxt": "300 14px/1.3 --fontFamily-googleSourceSansPro",
		"desccomp": "300 20px --fontFamily-googleSourceSansPro"
	},
	"boxShadow": {
