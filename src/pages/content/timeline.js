...
export default (() => {
	return <Theme theme={theme}>
		<GlobalQuarklyPageStyles pageUrl={"content/timeline"} />
		<Helmet>
			<title>
				Quarkly export
			</title>
		...
		<Components.Shapka />
		<Components.HeroBlock background="#181C22 url(https://uploads.quarkly.io/5f5604b57f10ba001eacfed1/images/timelinerrrrrrr.png?v=2020-10-09T02:44:04.541Z) 95% 100%/15% no-repeat">
			<Override slot="text">
				Timeline{"\n\n"}
			</Override>
			<Override slot="text1">
			...
			<Stack width="100%">
				...
				<StackItem width="100%" display="flex">
					...
					<Components.Table
						...
						data="Number of items ;Количество ячеек;Input;,Alignment of items  on the desktop;Формат отображения на декстопе;Checkbox,Alignment of items  on the mobile;Формат отображения на мобильных устройвах;Checkbox, Mobile starts with the breakpoint;Задать Breakpoint при котором активируется мобильная версия компонента;Input"
						border-radius="0px"
						box-shadow="--l"
						font="--base"
